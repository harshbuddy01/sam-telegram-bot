...
FEEDBACK_CHANNEL_ID = int(os.getenv("FEEDBACK_CHANNEL_ID", "0")) or NOTIFICATION_CHANNEL_ID
FEEDBACK_CHANNEL_LINK = os.getenv("FEEDBACK_CHANNEL_LINK", os.getenv("CHANNEL_LINK", "https://t.me/SamStoreServices"))
