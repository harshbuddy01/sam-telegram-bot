...
DEFAULT_TEMPLATES: Dict[str, str] = {
    ...
    "guide_text": (
        ...
        f"{UI.SECTION_BAR}\n\n"
        f"<b>{ce(CustomEmojis.SPARKLE, '1️⃣')} Browse Subscriptions</b>\n"
        ...
        f"<b>{ce(CustomEmojis.WALLET, '2️⃣')} Choose Plan & Instant Checkout</b>\n"
        ...
        f"<b>{ce(CustomEmojis.FIRE, '3️⃣')} Instant Automated & Manual Delivery</b>\n"
        ...
        f"<b>{ce(CustomEmojis.ORDERS, '4️⃣')} Order History & 1-Tap Copy</b>\n"
        ...
        f"<b>{ce(CustomEmojis.WARRANTY, '5️⃣')} 100% Replacement Warranty & Support</b>\n"
        ...
        f"<b>{ce(CustomEmojis.REFER, '6️⃣')} Invite Friends & Earn Cashback</b>\n"
